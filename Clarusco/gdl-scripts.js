jQuery(document).ready(function(){
	...
	jQuery(".blog-item-holder .blog-thumbnail-image-hover , .portfolio-item .portfolio-thumbnail-image-hover").hover(function(){
		jQuery(this).animate({ opacity: 0.5, 'border-width':'0px' }, 300);
	}, function(){
		jQuery(this).animate({ opacity: 0, 'border-width':'0px' }, 300);
	});
	
	// 
	jQuery(".highlight-wrapper").hover(function(){
		jQuery(this).animate({ opacity: 0.7, 'border-width':'0px' }, 300);
	}, function(){
		jQuery(this).animate({ opacity: 1, 'border-width':'0px' }, 300);
	});
