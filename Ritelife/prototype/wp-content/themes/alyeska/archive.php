...
<div id="content">
	...
	<h1>
        <?php if (have_posts()) : ?>
    		...
    		<?php } ?>
    	<?php endif; ?>
    </h1><div style="position:absolute; left:412px; top:87px;"><?php echo category_description(); ?></div>
<?php if (is_category( 'articles' )) : ?>
<img src="http://rite4life.com.au/prototype/wp-content/uploads/2011/12/articles.jpg"/><br style="margin-bottom:10px;"/>
<?php endif; ?>
	...
	<div class="entry">
		...
		<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" style="font-size:14px;">
			<span class="left">
				<span class="right">
