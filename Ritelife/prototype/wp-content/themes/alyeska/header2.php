...
<head>
    ...
    <link rel="stylesheet" href="http://code.jquery.com/ui/1.9.2/themes/base/jquery-ui.css" />
     ...
     <!-- Sortable Table CSS -->
      ...
      <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/layout/css/style/blue/style.css" />
...
<div id="wrapper">
	...
	<div id="header-wrapper">
		...
		<div id="header">
	        ...
	        <a href="<?php bloginfo('url'); ?>/member" title="<?php bloginfo('title'); ?>" id="logo">
			...
			<?php echo alyeska_social(); ?><div style="position:absolute; right:20px; top:10px;"><img src="http://rite4life.com.au/prototype/wp-content/uploads/2011/08/ip-logo.png" /></div> 
			...
			<div id="menu-inner" class="<?php echo $themeblvd_layout_menu_shape; ?>-<?php echo $themeblvd_layout_menu_color; ?>">
				...
				<div class="menu-middle">
					...
					<div class="menu-middle-inner">
						...
						<!-- <?php wp_nav_menu( array('container' => '', 'theme_location' => 'subscriber', 'fallback_cb' => 'themeblvd_menu_fallback' ) ); ?> --> <?php
