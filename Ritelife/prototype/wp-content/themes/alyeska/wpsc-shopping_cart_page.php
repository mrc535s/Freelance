   ...
   <?php if(wpsc_uses_shipping()) : ?>
      ...
      <table class="productcart">
         <tr class="wpsc_shipping_info">
            <td colspan="5">
               <?php _e('Please choose a country below to calculate your shipping and handling costs', 'wpsc'); ?>
            </td>
         </tr>
   ...
   ?>
      <table class="productcart">
         <tr class="total_price total_tax">
            ...
            <td colspan="2">
               <span id="checkout_tax" class="pricedisplay checkout-tax">$5.00</span>
            </td>
         </tr>
         <tr class="total_price total_tax">
            <td colspan="3">
      ...
      <?php if(wpsc_uses_shipping()) : ?>
	      ...
	      <tr class="total_price total_shipping">
	         <td class='wpsc_totals'>
	            <?php _e('Total Shipping', 'wpsc'); ?> and Handling:
	         </td>
	         <td class='wpsc_totals'>
