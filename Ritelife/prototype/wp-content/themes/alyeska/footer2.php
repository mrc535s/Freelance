...
?>
				...
				<div id="footer-bottom">This resource is for the exclusive use of Rite 4 Life Australia’s Ideal Protein weight loss, health and vitality protocol participants.  PLEASE DO NOT PLACE AN ORDER IF YOU ARE NOT A REGISTERED MEMBER ON THIS SITE. DO NOT PLACE AN ORDER FOR ANOTHER PERSON. DO NOT GIVE YOUR USER NAME AND PASSWORD TO SOMEONE ELSE TO USE ON THIS SITE.  Your membership may be terminated and any/all orders cancelled, and the amount(s) charged to your credit card refunded. This may take several days for the credit card company to process the credit.<!-- --></div>
