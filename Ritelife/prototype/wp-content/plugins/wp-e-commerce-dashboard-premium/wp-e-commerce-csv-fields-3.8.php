...
function parse_state ($state) {
	...
	if ( is_numeric($state) ) {
		...
		return wpsc_get_state_by_id ($state, 'name');
...
$ses_wpscd_csv_fields_available = Array (
	...
	'tax-total' => Array (	'Title'=>__('Total Order Tax', 'ses_wpscd'),
				'ShowOn' => 'Orders',
				'QueryID'=>'$cart_data["tax"] + $purchase["wpec_taxes_total"]'),
	...
	'order-status' => Array ('Title'=>__('Order Status', 'ses_wpscd'),
				'ShowOn' => 'Both',
				'QueryID'=>'$statuses[$purchase["processed"]]["label"]'),
	...
	'billing-state' => Array ('Title'=>__('State', 'ses_wpscd'),
				'ShowOn' => 'Both',
				'QueryID'=>'parse_state($assoc_checkout["billingstate"]["value"])'),
	...
	'shipping-state' => Array ('Title'=>__('Shipping State', 'ses_wpscd'),
				'ShowOn' => 'Both',
				'QueryID'=>'parse_state($assoc_checkout["shippingstate"]["value"])'),
